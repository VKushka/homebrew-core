class VitePlus < Formula
  ...
  def install
    ...
    # Deduplicate as the virtual store symlinks each package's dependencies beside it
    rm_r node_modules.glob(".pnpm/*/node_modules/*/prebuilds/{darwin,ios}-x64*").uniq(&:realpath)
